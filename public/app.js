...
const COLOR_THEMES = {
  ...
  "ember-dark": {
    "--panel": "rgba(40, 27, 20, 0.94)",
    "--panel-strong": "#2a1c14",
    "--line": "rgba(255, 214, 179, 0.18)",
    "--text": "#fff3e8",
    "--muted": "#c9aa92",
    "--accent": "#e36a35",
    "--accent-strong": "#ffb083",
    "--chip": "#553120",
    "--control-bg": "rgba(255, 235, 215, 0.08)",
    "--field-bg": "rgba(255, 244, 232, 0.1)",
    "--shadow": "0 20px 60px rgba(12, 7, 4, 0.34)",
    "--glow-one": "rgba(227, 106, 53, 0.2)",
    "--glow-two": "rgba(73, 151, 104, 0.14)",
    "--surface-start": "#1f1712",
    "--surface-end": "#2c1c13",
    "--player-start": "rgba(15, 10, 7, 0.94)",
    "--player-end": "rgba(48, 28, 16, 0.98)",
    "--player-base": "#100a07",
  },
  "forest-dark": {
    "--panel": "rgba(18, 35, 26, 0.94)",
    "--panel-strong": "#12231a",
    "--line": "rgba(198, 232, 188, 0.18)",
    "--text": "#edf8e9",
    "--muted": "#a8c0a4",
    "--accent": "#4da36f",
    "--accent-strong": "#a6e2b8",
    "--chip": "#274731",
    "--control-bg": "rgba(229, 255, 224, 0.08)",
    "--field-bg": "rgba(239, 255, 234, 0.1)",
    "--shadow": "0 20px 60px rgba(5, 12, 8, 0.34)",
    "--glow-one": "rgba(77, 163, 111, 0.2)",
    "--glow-two": "rgba(209, 143, 52, 0.13)",
    "--surface-start": "#0f1b14",
    "--surface-end": "#172d20",
    "--player-start": "rgba(7, 18, 12, 0.94)",
    "--player-end": "rgba(21, 50, 31, 0.98)",
    "--player-base": "#07120c",
  },
  "marine-dark": {
    "--panel": "rgba(17, 34, 45, 0.94)",
    "--panel-strong": "#112631",
    "--line": "rgba(183, 229, 244, 0.18)",
    "--text": "#eaf8ff",
    "--muted": "#a6bdc9",
    "--accent": "#49a5c8",
    "--accent-strong": "#a9e3f5",
    "--chip": "#254a5b",
    "--control-bg": "rgba(223, 247, 255, 0.08)",
    "--field-bg": "rgba(236, 251, 255, 0.1)",
    "--shadow": "0 20px 60px rgba(4, 11, 16, 0.34)",
    "--glow-one": "rgba(73, 165, 200, 0.2)",
    "--glow-two": "rgba(212, 91, 91, 0.13)",
    "--surface-start": "#0d1a22",
    "--surface-end": "#122d3b",
    "--player-start": "rgba(5, 13, 18, 0.94)",
    "--player-end": "rgba(19, 48, 63, 0.98)",
    "--player-base": "#050d12",
  },
  "mono-dark": {
    "--panel": "rgba(23, 28, 38, 0.94)",
    "--panel-strong": "#171c26",
    ...
    "--chip": "#303747",
    "--control-bg": "rgba(245, 247, 250, 0.08)",
    "--field-bg": "rgba(250, 250, 250, 0.1)",
    "--shadow": "0 20px 60px rgba(4, 6, 10, 0.34)",
    "--glow-one": "rgba(138, 150, 168, 0.16)",
    "--glow-two": "rgba(183, 121, 31, 0.12)",
    "--surface-start": "#10131a",
    "--surface-end": "#1d2430",
    "--player-start": "rgba(6, 8, 12, 0.94)",
    "--player-end": "rgba(29, 36, 48, 0.98)",
    "--player-base": "#06080c",
  },
};
